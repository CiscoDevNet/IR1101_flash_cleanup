...
3.  To Run the python script from FND 4.11, following packages needs to be installed,
      netmiko 2.3.3
      textfsm 0.4.1
...
FindPkgFiles_v5.py uses routers.txt

6. DelInstalBootFiles_v9.py script will delete .pkg and .conf files from flash: if router is booted with .bin (bundle boot) uses "routers_with_pkg.txt" as input.
